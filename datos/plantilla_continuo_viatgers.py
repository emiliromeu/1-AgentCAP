# Plantilla de colocació pedagògica del CAP CONTINU de viatgers (35h).
#
...
PLANTILLA_CONTINUO_VIATGERS = [
    ...
    ("2.1",     7),
    # Mòdul 6 — Sensibilització i Educació Viària (14h, un sol bloc)
    ("Mòdul 6", 14),
]
...
OBLIGATORIAS_FINDE_CONTINUO_VIATGERS = set()
AMPLIACION_CONTINUO_VIATGERS = set()
